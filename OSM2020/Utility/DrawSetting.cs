...
namespace OSM2020.Utility
{
    class DrawSetting
    {
        ...
        public List<Pen> CommuntyPens;
        public Pen BadCommunityPen;
        ...
        public DrawSetting()
        {
            ...
            this.SensorPen = new Pen(Color.Black);
            ...
            this.CommuntyPens = new List<Pen>()
            {
                new Pen(Color.Aqua),new Pen(Color.Orange),new Pen(Color.Yellow),new Pen(Color.Pink),new Pen(Color.Azure)
            };
            foreach(var compen in this.CommuntyPens)
            {
                compen.Width = 3f;
            }

            this.BadCommunityPen = new Pen(Color.DarkGray);
            this.BadCommunityPen.Width = 3f;
